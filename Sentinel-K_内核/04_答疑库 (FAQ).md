...
## 16. 视频精读界面体验与双语字幕显示优化
- **问题**: 侧边栏视频播放器显示偏窄（200px）导致画面看不清；字幕列表中中英原文和译文挤在同一行难以辨认，且高斯模糊遮罩影响英文原文流畅阅读。
- **对策**:
  1. **视频区域增高**：将 HTML5 播放器的 CSS 最大高度增大至 280px，将 YouTube/B站 IFrame 容器的高度提升至 240px，纵向可视面积得到明显优化。
